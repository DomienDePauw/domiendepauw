...
- **[ConsultantDetail-AllPhi]**: Group-assignment, making a webapplication using AzureDevOps,EF CORE, ASP.NET CORE, REACT FRONT-END,...
- **[DottFietsAPI]**: AzureDevOps, ASP.NET CORE, DOCKER SERVICE,...
