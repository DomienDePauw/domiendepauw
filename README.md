...
- **[ConsultantDetail-AllPhi](https://github.com/DomienDePauw/StripsEindopdracht)**: Group-assignment, making a webapplication using AzureDevOps, EF CORE, ASP.NET CORE, REACT,...
- **[DottFietsAPI](https://github.com/DomienDePauw/StripsEindopdracht)**: AzureDevOps, ASP.NET CORE, DOCKER,...
